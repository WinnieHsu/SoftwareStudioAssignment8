...
public class MainActivity extends Activity implements android.view.View.OnClickListener{
    ...
    public void onClick(View v) {
        ...
        //S = "The result from App is "+ num1 + " " + oper + " " + num2 + " = " + result;
        Thread t = new thread();
        t.start();
    }
    ...
    class thread extends Thread{
        public void run(){
            ...
            try{
                ...
                System.out.println("Connected in MainActivity!");
                ...
                String S = "The result from App is "+ num1 + " " + oper + " " + num2 + " = " + result;
                byte[] sendResultByte = new byte[1024];
                System.arraycopy(S.getBytes(), 0, sendResultByte, 0, S.length());
                out.write(sendResultByte);
